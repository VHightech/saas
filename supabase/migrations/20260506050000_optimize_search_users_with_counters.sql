-- Migration: 20260506050000_optimize_search_users_with_counters.sql
-- Description: Updates the search_users RPC to use the pre-calculated count columns
-- in the profiles table, significantly improving search and sort performance.
